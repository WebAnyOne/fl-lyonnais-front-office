...
import InfosPro from '../components/InfosPro'
import EditionContext from '../components/EditionContext'
import API from '../components/API'
import { Helmet } from 'react-helmet'
import { isFrenchMobile, isValidURL } from '../components/functionshelper'
...
import '../components/ImageCropInput.css'
      ...
      <main className={classes.layout}>
        <Paper className={classes.paper}>
          <Stepper activeStep={activeStep} className={classes.stepper}>
            {steps.map((label) => (
              <Step key={label}>
                <StepLabel style={{ cursor: 'pointer' }} onClick={handleStep}>
                  {label}
                </StepLabel>
              </Step>
            ))}
