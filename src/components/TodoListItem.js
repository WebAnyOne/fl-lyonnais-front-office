      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
          <div className="RefPhoto">
            {props.reference.image ? (
              <img
                src={url + props.reference.image}
                alt={props.reference.name}
              />
            ) : (
              <img
                src="https://img.icons8.com/windows/96/000000/file-upload.png"
                alt="default"
              />
            )}
          </div>
          <div>
            <div className={classes.root}>
              <ImageCropInput
                ...
                cropSize={(100, 170)}
                renderValidateButton={(onClick, disabled) => (
                  <Button
                    onClick={onClick}
                    disabled={disabled}
                    variant="contained"
                ...
                renderCancelButton={(onClick, disabled) => (
