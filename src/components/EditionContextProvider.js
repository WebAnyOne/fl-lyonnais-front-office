...
class EditionContextProvider extends React.Component {
  ...
  deleteChosenTag = (tagId) => {
    this.setState({
      chosenTags: this.state.chosenTags.filter((tag) => tag.id !== tagId),
    })
  }
  ...
  deleteReference = (refId) => {
    this.setState({
      references: this.state.references.filter((ref) => ref.id !== refId),
    })
  }
    ...
    return (
      <div>
        <EditionContext.Provider
          value={{
            ...this.state,
            setFreelanceId: this.setFreelanceId,
            setNewReferenceName: this.setNewReferenceName,
            closeModal: this.closeModal,
            showErrorMessage: this.showErrorMessage,
            clearUrlPro: this.clearUrlPro,
            setUrlPhoto: this.setUrlPhoto,
            sendFlDatasToFormEdition: this.sendFlDatasToFormEdition,
            deleteChosenTag: this.deleteChosenTag,
            setChosenTags: this.setChosenTags,
            setAllTags: this.setAllTags,
            deleteReference: this.deleteReference,
            setReferenceField: this.setReferenceField,
            addReference: this.addReference,
            handleUrlLink: this.handleUrlLink,
            handleAdressFormChange: this.handleAdressFormChange,
            handleTag: this.handleTag,
            handleTagId: this.handleTagId,
            addIdTagIdsChosen: this.addIdTagIdsChosen,
            handleReferencesName: this.handleReferencesName,
            handleNameReferenceList: this.handleNameReferenceList,
            setNameReferenceList: this.setNameReferenceList,
            cleanProjectState: this.cleanProjectState,
